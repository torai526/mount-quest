...
let analysisMoves=[];
let analysisResults=[];
let analysisSelectedIndex=-1;
let questMode=false;
let currentQuest=null;
let questPlayerMoves=0;
let questUsedHero=false;
let questFailedReason='';
let matchUndoCount=0;
let matchGodCount=0;
let matchMountCount=0;
let lastProgressAward=null;
let lastRecordedOutcome=null;
...
applySavedSettings();
applyCustomization();
scheduleTimer(showStartupNotices,120);
