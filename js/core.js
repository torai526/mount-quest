...
function imageTag(name,alt,cls='piece-img'){return `<img class="${cls}" src="assets/webp/${name}.webp?v=18" data-fallback="assets/${name}.png?v=18" alt="${alt}" decoding="async" width="512" height="512" onerror="if(this.dataset.fallback&&this.src.indexOf('.png')<0)this.src=this.dataset.fallback">`}
