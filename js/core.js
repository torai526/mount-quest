...
function imageTag(name,alt,cls='piece-img'){return `<img class="${cls}" src="assets/webp/${name}.webp?v=19" data-fallback="assets/${name}.png?v=19" alt="${alt}" decoding="async" width="512" height="512" onerror="if(this.dataset.fallback&&this.src.indexOf('.png')<0)this.src=this.dataset.fallback">`}
...
function defaultData(){return {version:DATA_VERSION,games:0,wins:0,losses:0,draws:0,covers:0,byDifficulty:{easy:{w:0,l:0},medium:{w:0,l:0},hard:{w:0,l:0},expert:{w:0,l:0}},unlocked:{},settings:{...DEFAULT_SETTINGS}}}
